...
static Efl_Model *
_efl_model_composite_efl_ui_view_model_get(Eo *obj EINA_UNUSED, Efl_Model_Composite_Data *pd)
{
   return pd->source;
}
...
static Eina_Value *
_efl_model_composite_efl_model_property_get(Eo *obj EINA_UNUSED, Efl_Model_Composite_Data *pd,
                                            const char *property)
{
...
static Eina_Array *
_efl_model_composite_efl_model_properties_get(Eo *obj EINA_UNUSED, Efl_Model_Composite_Data *pd)
{
   return efl_model_properties_get(pd->source);
}

static unsigned int
_efl_model_composite_efl_model_children_count_get(Eo *obj EINA_UNUSED, Efl_Model_Composite_Data *pd)
{
